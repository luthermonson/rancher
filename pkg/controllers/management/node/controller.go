...
const (
	...
	nodeScaledownAnnotation            = "nodes.management.cattle.io/scaledown"
)
...
func (m *Lifecycle) Updated(obj *v3.Node) (runtime.Object, error) {
	newObj, err := v32.NodeConditionProvisioned.Once(obj, func() (runtime.Object, error) {
		...
		if obj.Spec.ScaledownTime != "" {
			if scaledownAnnotation, ok := obj.Annotations[nodeScaledownAnnotation]; !ok || scaledownAnnotation != "true" {
